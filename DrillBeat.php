...
<body style="background-color: #181818">
    ...
    <div class="feed-container">
        <h1 class="feed-title">Drill Beat</h1>
        <?php
        ...
        $sql = "SELECT idpost, user, content, caminho, timestamp FROM posts WHERE sub_category = 'Drill Beat' AND main_category='beat'ORDER BY timestamp DESC";
        $stmt = $conn->query($sql);
