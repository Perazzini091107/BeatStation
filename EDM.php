...
<body style="background-color: #181818">
    ...
    <div class="feed-container">
        ...
        $sql = "SELECT idpost, user, content, caminho, timestamp FROM posts WHERE sub_category = 'EDM Beat' AND main_category='musica' ORDER BY timestamp DESC";
        $stmt = $conn->query($sql);
