...
$sql = "SELECT idpost, user, content, caminho, timestamp FROM posts WHERE user = '$user' AND main_category='musica' ORDER BY timestamp DESC";
...
<body>
    ...
    <div class="profile-header">
        ...
        <p style="margin-left: 320px; font-size: 20px;">
            <b style="color: #29fd53;"><?php echo $seguidores; ?></b> Followers |
            <b style="color: #29fd53;"><?php echo $seguindo; ?></b> Following
        </p>
